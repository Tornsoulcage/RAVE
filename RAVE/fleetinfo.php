...
<html lang = "en">
	...
	<body>
		<div class = "container">
			...
			<div class = "row">
				<article>
					...
					<p class = "adminRights"><a href = "editfleet.php">Edit Fleet</a></p>
					<p class = "genRights"><a href = "viewfleet.php">View Fleet</a></p>
					<p class = "adminRights"><a href = "weeklyCheckup.php">Weekly Checkup</a></p>
				</article>
			</div>
			<div class = "row">
				<footer>
		...
		<script>setUserRights('fleetinfo');</script>
	</body>
</html>