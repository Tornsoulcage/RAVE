					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav">
								<li class = "allRights active"><a href="login.php">Login</a></li>
								<li class = "adminRights"><a href="fleetinfo.php">Fleet Information</a></li>
								<li class = "adminRights"><a href = "maintenanceinfo.php">Maintenance Information</a></li>
								<li class = "adminRights"><a href="scheduleinfo.php">Schedule Information</a></li> 
								<li class = "adminRights"><a href="analyzecosts.php">Analyze Costs</a></li>
				...
				<article class = "allRights">
					<form id = "loginForm" onsubmit = "return false">
						<fieldset class = "databaseForms">
							...
							<label for = "userInput">
								User ID
								<input type = "text" name = "userInput" id = "userInput" placeholder = "User ID">
							</label>
						...
						<input type = "submit" class = "confirmButton placeCenter" onclick = "login()" value = "Login">
					</form>
				</article>
			</div>
			<div class = "row">
