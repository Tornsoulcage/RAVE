					...
					<form autocomplete = "off" id = "viewVehicleForm" onsubmit = "return false">
						...
						<fieldset class = "databaseForms">
							...
							<label for = "editEngineInput">
								Engine
								<input type = "text" name = "editEngineInput" id = "editEngineInput" placeholder = "Engine" readonly>
							</label>
							<label for = "editTiresInput">
								Tires
								<select id = "editTiresInput" name = "editTiresInput" disabled>
								...
								<label for = "editConditionInput">
									Condition
									<select id = "editConditionInput" name = "editConditionInput" disabled>
							...
							<label for = "editRequiredLicenseInput">
								Required License
								<select id = "editRequiredLicenseInput" name = "editRequiredLicenseInput" disabled>
