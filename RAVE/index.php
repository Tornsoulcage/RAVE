					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav">
								<li class = "allRights active"><a href="index.php">Home</a></li>
				...
				<article class = "allRights">
					<form id = "welcomeForm" onsubmit = "return false">
						<fieldset class = "databaseForms">
							<legend>Welcome to RAVE</legend>
						</fieldset>
						<fieldset class = "databaseForms adminRights">
							<legend>Vehicle Alerts</legend>
							<table id = "vehicleAlerts">
