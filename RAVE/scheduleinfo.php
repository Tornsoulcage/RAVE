...
<html lang = "en">
	...
	<body>
		<div class = "container">
			...
			<div class = "row">
				<article>
					...
					<p class = "adminRights"><a href = "editschedule.php">Edit Schedule</a></p>
					<p class = "genRights"><a href = "viewschedule.php">View Schedule</a></p>
				</article>
			</div>
			<div class = "row">
				<footer>
		...
		<script>setUserRights('scheduleinfo');</script>
	</body>
</html>