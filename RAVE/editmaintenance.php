								...
								<fieldset class = "databaseForms">
									...
									<div class = "autocomplete">
										<label for = "addVehicleIDInput">
											Vehicle's ID
											<input type = "text" name = "addVehicleIDInput" id = "addVehicleIDInput" onblur = "selectPartialVehicle('add')" placeholder = "Vehicle's ID">
										</label>
									</div>
								</fieldset>
								<fieldset class = "databaseForms">
									...
									<label for = "addVINInput">
										Vehicle's VIN
										<input type = "text" name = "addVINInput" id = "addVINInput" placeholder = "Vehicle's VIN" readonly>
									</label>
								</fieldset>
								<fieldset class = "databaseForms">
								...
								<fieldset class = "databaseForms">
									...
									<div class = "autocomplete">
										<label for = "removeVehicleIDInput">
											Vehicle's ID
											<input type = "text" name = "removeVehicleIDInput" id = "removeVehicleIDInput" onblur = "selectMaintenance('removeDateInput', 'removeVehicleIDInput')" placeholder = "Vehicle's ID">
										</label>
									</div>
