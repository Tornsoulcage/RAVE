					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav">
							...
							<li class="allRights"><a href="maintenanceinfo.php">Maintenance
									Information</a></li>
							<li class="allRights active"><a href="scheduleinfo.php">Schedule
									Information</a></li>
			...
			<article class="adminRights">
				...
				<div class="tab-content">
					<div id="add" class="tab-pane fade in active">
						...
						<form autocomplete="off" id="addScheduleForm"
							onsubmit="return false">
							<fieldset class="databaseForms">
								<legend>Schedule Information</legend>
								<label for="addScheduleDateInput"> Date for Schedule <input
									type="date" id="addScheduleDateInput"
									name="addScheduleDateInput">
								</label>
								...
								<label for="addMechanicNameInput"> Mechanic Assigned <select
									id="addMechanicNameInput" name="addMechanicNameInput">
										<!-- Will be populated by javascript -->
								</select>
								</label> <label for="addScheduleTimeStartInput"> Start Time <input
									type="time" name="addScheduleTimeStartInput"
									id="addScheduleTimeStartInput">
							...
							<div class="col-xs-6 formcol">
								<input type="submit" class="confirmButton placeLeft"
									onclick="insertAppointment()" value="Confirm">
							</div>
						</form>
					</div>
					<div id="edit" class="tab-pane fade">
						<p>Form for editing Appointment Information</p>
						<form autocomplete="off" id="editScheduleForm"
							onsubmit="return false">
							<fieldset class="databaseForms">
								...
								<label for="scheduleDateInput"> Date to Edit <!-- Will be populated by Javascript -->
									<select id="scheduleDateInput"
									onchange="selectAppointmentDropDown()"></select>
								</label>
							</fieldset>
							<fieldset class="databaseForms">
								<legend>Schedule Information</legend>
								<label for="editScheduleDateInput"> Date for Schedule <input
									type="date" id="editScheduleDateInput"
									name="editScheduleDateInput">
								</label> <label for="editMechanicNameInput"> Mechanic Assigned <select
									id="editMechanicNameInput" name="editMechanicNameInput">
										<!-- Will be populated by javascript -->
								</select>
								</label> <label for="editScheduleTimeStartInput"> Start Time <input
									type="time" name="editScheduleTimeStartInput"
									id="editScheduleTimeStartInput">
								</label> <label for="editScheduleTimeRequired"> Time Required <input
									type="number" name="editScheduleTimeRequired"
									id="editScheduleTimeRequired" step=15
									placeholder="15 minute increments">
								</label> <label for="editScheduleDescription"> Description <input
									type="text" name="editScheduleDescription"
									id="editScheduleDescription" placeholder="REBUILD ENGINE">
								</label>
							</fieldset>
							<div class="col-xs-6 formcol">
								<input type="reset" class="confirmButton placeRight" id="reset"
							...
							<div class="col-xs-6 formcol">
								<input type="submit" class="confirmButton placeLeft"
									onclick="updateAppointment()" value="Confirm">
							</div>
						</form>
					</div>
					<div id="remove" class="tab-pane fade">
						<p>Form for removing an Appointment</p>
						<form autocomplete="off" id="removeScheduleForm"
							onsubmit="return false">
							<fieldset class="databaseForms">
								...
								<label for="removeScheduleDateInput"> Date for Schedule <select
									id="removeScheduleDateInput"></select>
								</label>
							</fieldset>
							<input type="submit" class="confirmButton placeCenter"
								onclick="removeAppointment()" value="Confirm">
						</form>
					</div>
				</div>
			</article>
