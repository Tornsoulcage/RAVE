	...
	<div class="container">
		...
		<div class="row">
			<article class="allRights">
				<h2>View Schedule</h2>
				<form id="viewScheduleForm" onsubmit="return false">
					<fieldset class="databaseForms">
						<label for="scheduleDateInput"> Date for Schedule <input
							type="date" id="scheduleDateInput" name="scheduleDateInput">
						</label>
					</fieldset>
					<input type="submit" class="confirmButton placeCenter"
						onclick="selectSchedule()" value="Confirm">
				</form>
				<!--  Will be populated via javascript/php -->
				<table id="calendar">
				</table>
			</article>
		</div>
