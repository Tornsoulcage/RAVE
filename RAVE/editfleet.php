						...
						<form autocomplete="off" id="addVehicleForm"
							...
							<fieldset class="databaseForms">
								...
								<label for="addDepartmentNameInput"> Department's Name <!-- Will be populated by Javascript -->
									...
									placeholder="Mileage">
								</label> <label for="addEngineInput"> Engine <input type="text"
									name="addEngineInput" id="addEngineInput" placeholder="Engine">
								</label> <label for="addTiresInput"> Tires <select
									id="addTiresInput" name="addTiresInput">
								...
								</label> <label for="addConditionInput"> Condition <select
									id="addConditionInput" name="addConditionInput">
										<option value="POOR">Poor</option>
										<option value="GOOD">Good</option>
										<option value="VERY GOOD">Very Good</option>
										<option value="EXCELLENT">Excellent</option>
								</select>
								</label> <label for="addRequiredLicenseInput"> Required License
									<select id="addRequiredLicenseInput"
									name="addRequiredLicenseInput">
							...
							<div class="col-xs-6 formcol">
								<input type="submit" class="confirmButton placeLeft"
									onclick="insertVehicle()" value="Confirm">
							</div>
						</form>
					</div>
					<div id="edit" class="tab-pane fade">
						<p>Sample Form for editing existing Vehicles</p>
						<form autocomplete="off" id="editVehicleForm"
							onsubmit="return false">
							<fieldset class="databaseForms">
							...
							<fieldset class="databaseForms">
								...
								<label for="editDepartmentNameInput"> Department's Name <!-- Will be populated by Javascript -->
									...
									name="editEngineInput" id="editEngineInput"
									placeholder="Engine">
								</label> <label for="editTiresInput"> Tires <select
									id="editTiresInput" name="editTiresInput">
										<option value="11/32">11/32</option>
										<option value="10/32">10/32</option>
										<option value="9/32">9/32</option>
										<option value="8/32">8/32</option>
									...
									id="editConditionInput" name="editConditionInput">
										<option value="POOR">Poor</option>
										<option value="GOOD">Good</option>
										<option value="VERY GOOD">Very Good</option>
										<option value="EXCELLENT">Excellent</option>
								</select>
								</label> <label for="editRequiredLicenseInput"> Required License
									<select id="editRequiredLicenseInput"
									name="editRequiredLicenseInput">
										<option value="CLASS_A">Class A</option>
										<option value="CLASS_B">Class B</option>
										<option value="CLASS_C">Class C</option>
										<option value="CLASS_D">Class D</option>
					...
					<div id="remove" class="tab-pane fade">
						...
						<form autocomplete="off" id="removeVehicleForm"
							...
							<input type="submit" class="confirmButton placeCenter"
								onclick="removeVehicle()" value="Confirm">
						</form>
					</div>
				</div>
			</article>
