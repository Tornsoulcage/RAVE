		...
		<div class = "container">
			...
			<div class = "row">
				...
				<p>Form for selecting and viewing Vehicle Information</p>
					<form autocomplete = "off" id = "viewMaintenanceForm" onsubmit = "return false">
						<fieldset class = "databaseForms">
							<legend>Select Vehicle ID and Date to View</legend>
							<div class = "autocomplete">
								<label for = "editVehicleIDInput">
									Vehicles ID
									<input type = "text" name = "editVehicleIDInput" id = "editVehicleIDInput" onblur = "selectPartialVehicle('edit'), selectMaintenanceTable('editVehicleIDInput')" placeholder = "Vehicles ID">
								</label>
							</div>
						</fieldset>
						<fieldset class = "databaseForms">
